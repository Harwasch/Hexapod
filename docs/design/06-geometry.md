...
The current rough geometry from four views. The body is a 900 × 442 × 200 mm slab
with six hip stacks under it on a 240 mm spacing, 330 mm apart along the
body. Each hip is three coaxial pancake actuators, Ø170 × 42 mm, on the yaw axis.
...
Each actuator has a Ø170 × 42 mm envelope including housing, bearings and
...
| Quantity | Value |
|---|---|
| Actuator envelope | Ø170 × 42 mm, ≤ 1.1 kg |
| Hip stack | 3 actuators + 2 × 8 mm = 142 mm tall inside the 200 mm slab |
| Envelope volume per actuator | 0.95 L |
