...
The current rough geometry from four views. The body is a 900 × 458 × 200 mm slab
with six hip stacks under it on a 240 mm spacing, 330 mm apart along the
body. Each hip is three coaxial pancake actuators, Ø186 × 50 mm, on the yaw axis.
Each leg is coxa 150 / femur 250 / tibia 500 mm. The sprawl stance stands with
the femur axis 323 mm and the deck 541 mm above ground; the mammal
stance, same robot, 644 mm and 862 mm.
...
Each actuator has a Ø186 × 50 mm envelope including housing, bearings and
...
| Quantity | Value |
|---|---|
| Actuator envelope | Ø186 × 50 mm, ≤ 3.9 kg |
| Hip stack | 3 actuators + 2 × 8 mm = 166 mm tall inside the 200 mm slab |
| Envelope volume per actuator | 1.36 L |
