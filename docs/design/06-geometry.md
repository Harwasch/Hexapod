...
body. Each hip is three coaxial pancake actuators, Ø192 × 62 mm, on the yaw axis.
...
Each actuator has a Ø192 × 62 mm envelope including housing, bearings and
...
| Quantity | Value |
|---|---|
| Actuator envelope | Ø192 × 62 mm, ≤ 6.0 kg |
| Hip stack | 3 actuators + 2 × 8 mm = 202 mm tall inside the 220 mm slab |
| Envelope volume per actuator | 1.79 L |
