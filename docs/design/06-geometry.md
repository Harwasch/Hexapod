...
The current rough geometry from four views. The body is a 900 × 464 × 220 mm slab
with six hip stacks under it on a 240 mm spacing, 330 mm apart along the
body. Each hip is three coaxial pancake actuators, Ø192 × 54 mm, on the yaw axis.
...
Each actuator has a Ø192 × 54 mm envelope including housing, bearings and
...
| Quantity | Value |
|---|---|
| Actuator envelope | Ø192 × 54 mm, ≤ 5.3 kg |
| Hip stack | 3 actuators + 2 × 8 mm = 178 mm tall inside the 220 mm slab |
| Envelope volume per actuator | 1.56 L |
