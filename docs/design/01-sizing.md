...
178 mm tall and Ø192 mm, so the body is a
...
| Actuator envelope | Ø192 × 54 mm, ≤ 5.3 kg | pancake; three stacked per hip on the yaw axis |
...
|---|---|---|---|---|---|---|---|
| Walk, tripod gait | continuous | 132 | 3 | 1.5 | 30° + 1.0 m/s² | **649** | 261 |
| Stumble / step-down, two legs | peak | 132 | 2 | 3.0 | 0° + 2.0 m/s² | **1948** | 132 |
| Rider, wave gait (stretch) | stretch | 224 | 3 | 1.2 | 15° + 0.3 m/s² | **881** | 212 |
...
|---|---|---|---|---|
| Walk, tripod gait | continuous | 74 | **157** | 65 |
| Stumble / step-down, two legs | peak | 37 | **366** | 33 |
| Rider, wave gait (stretch) | stretch | 60 | **190** | 53 |
...
| with rider (stretch) | 0.65 | 19° | 37° | 0.89 × 0.99 |
...
|---|---|---|---|---|---|---|---|---|---|---|
| yaw | 85 | 127 | 53 | **127** | **135** | 69 | 6 | 1 stator, **50:1** | 136 / 413 | 11.5 |
| femur | 140 | 267 | 314 | **314** | **570** | 176 | 4 | 2 stators, **80:1** | 436 / 1320 | 7.2 |
| knee | 39 | 284 | 332 | **332** | **697** | 32 | 4 | 2 stators, **80:1** | 436 / 1320 | 7.2 |
...
sees weight, still needs 127 N·m for propulsion on a 30° slope over a
...
| Yaw bearing overturning moment (structural) | 637 N·m | peak foot load × foot radius; carried by the coxa and the yaw bearing, not the motor |
...
| Envelope | Ø192 × 54 mm | pancake, axis = hip yaw axis |
| Mass | ≤ 5.3 kg (femur); less for yaw and knee | one motor, three ratios |
| Bus voltage | 48 V | 13S Li-ion; 48 V drivers and connectors are commodity |
| Continuous mechanical power, per leg | ~765 W | femur and yaw continuous torque × their stance rates |
| Peak mechanical power, per joint | ~3.5 kW | peak torque × 5 rad/s |
...
* A single-stage cycloid ratio equals its lobe count. 80 lobes on a disc that
  ...
  printed or aluminium parts at 697 N·m. The output torque reacts through
  those pins at ~47 mm radius, so the net pin load at peak is ~14.8 kN
...
|---|---|---|
| Average electrical power, 1 m/s walk | 1419 W | cost of transport 1.0 × m·g·v + 120 W hotel |
| Average electrical power, rider at 0.3 m/s (stretch) | 780 W | same model |
| Endurance target | 2 h walking | mission length |
| Battery, each of 2 | **1419 Wh, 30 Ah at 48 V, ~8.3 kg** | 170 Wh/kg pack level |
| Peak bus current | ~218 A | six joints near peak power, 50 % coincidence |
...
in the ~2.8 kWh, two 8 kg packs range, which the mass budget carries.

## 9. What this pass decided and what it left open

Decided in review, or proposed here:

1. Robot ~124 kg, 0.9 × 0.46 × 0.2 m slab body with the hips under it, hips 0.32 m up.
...
4. Per-DOF actuators (agreed): yaw 127 / 135, femur 314 / 570, knee 332 / 697 N·m continuous / peak; 8 rad/s at the yaw; Ø192 × 54 mm.
