...
R_OUT = 80.2                # outermost coil copper
R_VIA_T = 80.9              # terminal vias
R_M = 81.75                 # M-node arcs (In9/In10/B.Cu), 0.7 wide: 81.4-82.1
R_RING = {"A": 82.7, "B": 83.6, "C": 84.5}   # phase rings (3 layers each), 0.7 wide, 0.2 space
R_N = 50.9                  # star ring, inner band (In9/In10/B.Cu)
R_PAD = 86.0                # phase terminal pads
R_BOARD = 87.5              # board edge
R_BORE = 50.0
RING_W = 0.7
M_W = 0.7
STUB_W = 0.4
