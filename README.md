...
A large-dog-sized hexapod for outdoor missions — complex terrain first, then trash pickup — with all eighteen motors in the body.
...
**0/16 chunks complete** · 16 sessions on the critical path · [editable version](docs/plan.drawio)
